-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- 
-- $Id: postgis.sql.in.c 4201 2009-06-24 10:57:04Z mcayland $
--
...
CREATE OR REPLACE FUNCTION spheroid_in(cstring)
	RETURNS spheroid 
	AS 'C:/xampp/pgsql/bin/postgis-1.4','ellipsoid_in'
...
CREATE OR REPLACE FUNCTION spheroid_out(spheroid)
	RETURNS cstring 
	AS 'C:/xampp/pgsql/bin/postgis-1.4','ellipsoid_out'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_in(cstring)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_in'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_out(geometry)
	RETURNS cstring
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_out'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_analyze(internal)
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_analyze'
...
CREATE OR REPLACE FUNCTION geometry_recv(internal)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_recv'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_send(geometry)
	RETURNS bytea
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_send'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION Affine(geometry,float8,float8,float8,float8,float8,float8,float8,float8,float8,float8,float8,float8)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_affine'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION shift_longitude(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_longitude_shift'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box3d_in(cstring)
	RETURNS box3d 
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX3D_in'
	LANGUAGE 'C' IMMUTABLE STRICT; 

-- Deprecation in 1.2.3
CREATE OR REPLACE FUNCTION box3d_out(box3d)
	RETURNS cstring 
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX3D_out'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box3d_extent_out(box3d_extent)
	RETURNS cstring 
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX3D_extent_out'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION ST_box3d_extent(box3d_extent)
	RETURNS box3d
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX3D_extent_to_BOX3D'
	LANGUAGE 'C' IMMUTABLE STRICT; 

CREATE OR REPLACE FUNCTION ST_box2d(box3d_extent)
	RETURNS box2d
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX3D_to_BOX2DFLOAT4'
	LANGUAGE 'C' IMMUTABLE STRICT; 

CREATE OR REPLACE FUNCTION ST_geometry(box3d_extent)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','BOX3D_to_LWGEOM'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION xmin(box3d)
	RETURNS FLOAT8
	AS 'C:/xampp/pgsql/bin/postgis-1.4','BOX3D_xmin'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION ymin(box3d)
	RETURNS FLOAT8
	AS 'C:/xampp/pgsql/bin/postgis-1.4','BOX3D_ymin'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION zmin(box3d)
	RETURNS FLOAT8
	AS 'C:/xampp/pgsql/bin/postgis-1.4','BOX3D_zmin'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION xmax(box3d)
	RETURNS FLOAT8
	AS 'C:/xampp/pgsql/bin/postgis-1.4','BOX3D_xmax'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION ymax(box3d)
	RETURNS FLOAT8
	AS 'C:/xampp/pgsql/bin/postgis-1.4','BOX3D_ymax'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION zmax(box3d)
	RETURNS FLOAT8
	AS 'C:/xampp/pgsql/bin/postgis-1.4','BOX3D_zmax'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION chip_in(cstring)
	RETURNS chip 
	AS 'C:/xampp/pgsql/bin/postgis-1.4','CHIP_in'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION chip_out(chip)
	RETURNS cstring 
	AS 'C:/xampp/pgsql/bin/postgis-1.4','CHIP_out'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box2d_in(cstring)
	RETURNS box2d
	AS 'C:/xampp/pgsql/bin/postgis-1.4','BOX2DFLOAT4_in'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box2d_out(box2d)
	RETURNS cstring
	AS 'C:/xampp/pgsql/bin/postgis-1.4','BOX2DFLOAT4_out'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box2d_overleft(box2d, box2d) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX2D_overleft'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box2d_overright(box2d, box2d) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX2D_overright' 
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box2d_left(box2d, box2d) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX2D_left' 
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box2d_right(box2d, box2d) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX2D_right' 
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box2d_contain(box2d, box2d) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX2D_contain'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box2d_contained(box2d, box2d) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX2D_contained'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box2d_overlap(box2d, box2d) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX2D_overlap'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box2d_same(box2d, box2d) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX2D_same'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box2d_intersects(box2d, box2d) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX2D_intersects'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_lt(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'lwgeom_lt'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_le(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'lwgeom_le'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_gt(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'lwgeom_gt'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_ge(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'lwgeom_ge'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_eq(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'lwgeom_eq'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_cmp(geometry, geometry) 
	RETURNS integer
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'lwgeom_cmp'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION postgis_gist_sel (internal, oid, internal, int4)
	RETURNS float8
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_gist_sel'
	LANGUAGE 'C';
...
CREATE OR REPLACE FUNCTION postgis_gist_joinsel(internal, oid, internal, smallint)
	RETURNS float8
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_gist_joinsel'
	LANGUAGE 'C';
...
CREATE OR REPLACE FUNCTION geometry_overleft(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_overleft'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_overright(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_overright'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_overabove(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_overabove'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_overbelow(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_overbelow'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_left(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_left'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_right(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_right'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_above(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_above'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_below(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_below'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_contain(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_contain'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_contained(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_contained'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_overlap(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_overlap'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry_same(geometry, geometry) 
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_same'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION addBBOX(geometry) 
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_addBBOX'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION dropBBOX(geometry) 
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_dropBBOX'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION getSRID(geometry) 
	RETURNS int4
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_getSRID'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION getBBOX(geometry)
	RETURNS box2d
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_to_BOX2DFLOAT4'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION srid(chip)
	RETURNS int4
	AS 'C:/xampp/pgsql/bin/postgis-1.4','CHIP_getSRID'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION height(chip)
	RETURNS int4
	AS 'C:/xampp/pgsql/bin/postgis-1.4','CHIP_getHeight'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION factor(chip)
	RETURNS FLOAT4
	AS 'C:/xampp/pgsql/bin/postgis-1.4','CHIP_getFactor'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION width(chip)
	RETURNS int4
	AS 'C:/xampp/pgsql/bin/postgis-1.4','CHIP_getWidth'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION datatype(chip)
	RETURNS int4
	AS 'C:/xampp/pgsql/bin/postgis-1.4','CHIP_getDatatype'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION compression(chip)
	RETURNS int4
	AS 'C:/xampp/pgsql/bin/postgis-1.4','CHIP_getCompression'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION setSRID(chip,int4)
	RETURNS chip
	AS 'C:/xampp/pgsql/bin/postgis-1.4','CHIP_setSRID'
	LANGUAGE 'C' IMMUTABLE STRICT; 

-- Deprecation in 1.2.3
CREATE OR REPLACE FUNCTION setFactor(chip,float4)
	RETURNS chip
	AS 'C:/xampp/pgsql/bin/postgis-1.4','CHIP_setFactor'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION mem_size(geometry)
	RETURNS int4
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_mem_size'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION summary(geometry)
	RETURNS text
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_summary'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION npoints(geometry)
	RETURNS int4
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_npoints'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION nrings(geometry)
	RETURNS int4
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_nrings'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION length3d(geometry)
	RETURNS FLOAT8
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_length_linestring'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION length2d(geometry)
	RETURNS FLOAT8
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_length2d_linestring'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION length3d_spheroid(geometry, spheroid)
	RETURNS FLOAT8
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_length_ellipsoid_linestring'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION length2d_spheroid(geometry, spheroid)
	RETURNS FLOAT8
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_length2d_ellipsoid_linestring'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION perimeter3d(geometry)
	RETURNS FLOAT8
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_perimeter_poly'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION perimeter2d(geometry)
	RETURNS FLOAT8
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_perimeter2d_poly'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION area2d(geometry)
	RETURNS FLOAT8
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_area_polygon'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION distance_spheroid(geometry,geometry,spheroid)
	RETURNS FLOAT8
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_distance_ellipsoid_point'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION distance_sphere(geometry,geometry)
	RETURNS FLOAT8
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_distance_sphere'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION distance(geometry,geometry)
	RETURNS float8
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_mindistance2d'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION max_distance(geometry,geometry)
	RETURNS float8
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_maxdistance2d_linestring'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION point_inside_circle(geometry,float8,float8,float8)
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_inside_circle_point'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION azimuth(geometry,geometry)
	RETURNS float8
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_azimuth'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION force_2d(geometry) 
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_force_2d'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION force_3dz(geometry) 
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_force_3dz'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION force_3dm(geometry) 
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_force_3dm'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION force_4d(geometry) 
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_force_4d'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION force_collection(geometry) 
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_force_collection'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION multi(geometry) 
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_force_multi'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION expand(box3d,float8)
	RETURNS box3d
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX3D_expand'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION expand(box2d,float8)
	RETURNS box2d
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX2DFLOAT4_expand'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION expand(geometry,float8)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_expand'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION envelope(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_envelope'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION reverse(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_reverse'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION ForceRHR(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_forceRHR_poly'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION noop(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_noop'
	LANGUAGE 'C' VOLATILE STRICT; 
...
CREATE OR REPLACE FUNCTION zmflag(geometry)
	RETURNS smallint
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_zmflag'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION hasBBOX(geometry)
	RETURNS bool
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_hasBBOX'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION ndims(geometry)
	RETURNS smallint
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_ndims'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION AsEWKT(geometry)
	RETURNS TEXT
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_asEWKT'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION AsEWKB(geometry)
	RETURNS BYTEA
	AS 'C:/xampp/pgsql/bin/postgis-1.4','WKBFromLWGEOM'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION AsHEXEWKB(geometry)
	RETURNS TEXT
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_asHEXEWKB'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION GeomFromEWKB(bytea)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOMFromWKB'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION GeomFromEWKT(text)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','parse_WKT_lwgeom'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION cache_bbox()
	RETURNS trigger
	AS 'C:/xampp/pgsql/bin/postgis-1.4'
	LANGUAGE 'C';

-- Availability: 1.2.2
CREATE OR REPLACE FUNCTION ST_Cache_BBox()
	RETURNS trigger
	AS 'C:/xampp/pgsql/bin/postgis-1.4','cache_bbox'
	LANGUAGE 'C';
...
CREATE OR REPLACE FUNCTION MakePoint(float8, float8)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_makepoint'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION MakePointM(float8, float8, float8)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_makepoint3dm'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION MakeBox2d(geometry, geometry)
	RETURNS box2d
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX2DFLOAT4_construct'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION MakeBox3d(geometry, geometry)
	RETURNS box3d
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX3D_construct'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION makeline_garray (geometry[])
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_makeline_garray'
	LANGUAGE 'C' IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION LineFromMultiPoint(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_line_from_mpoint'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION MakeLine(geometry, geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_makeline'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION AddPoint(geometry, geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_addpoint'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION RemovePoint(geometry, integer)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_removepoint'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION SetPoint(geometry, integer, geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_setpoint_linestring'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION MakePolygon(geometry, geometry[])
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_makepoly'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION BuildArea(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_buildarea'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION Polygonize_GArray (geometry[])
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'polygonize_garray'
	LANGUAGE 'C' IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION LineMerge(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'linemerge'
	LANGUAGE 'C' IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION Dump(geometry)
	...
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_dump'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION DumpRings(geometry)
	RETURNS SETOF geometry_dump
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_dump_rings'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION combine_bbox(box2d,geometry)
	RETURNS box2d
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX2DFLOAT4_combine'
...
CREATE OR REPLACE FUNCTION combine_bbox(box3d_extent,geometry)
	RETURNS box3d_extent
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'BOX3D_combine'
	LANGUAGE 'C' IMMUTABLE;
...
CREATE OR REPLACE FUNCTION estimated_extent(text,text,text) RETURNS box2d AS
	'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_estimated_extent'
...
CREATE OR REPLACE FUNCTION transform_geometry(geometry,text,text,int)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','transform_geom'
	LANGUAGE 'C' IMMUTABLE STRICT; 

CREATE OR REPLACE FUNCTION transform(geometry,integer)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','transform'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION postgis_scripts_build_date() RETURNS text
	AS 'SELECT ''2009-10-12 00:13:52''::text AS version'
	LANGUAGE 'sql' IMMUTABLE;
...
CREATE OR REPLACE FUNCTION box3d(geometry)
	RETURNS box3d
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_to_BOX3D'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box(geometry)
	RETURNS box
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_to_BOX'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box3d(box2d)
	RETURNS box3d
	AS 'C:/xampp/pgsql/bin/postgis-1.4','BOX2DFLOAT4_to_BOX3D'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION box(box3d)
	RETURNS box
	AS 'C:/xampp/pgsql/bin/postgis-1.4','BOX3D_to_BOX'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION text(geometry)
	RETURNS text
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_to_text'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry(box2d)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','BOX2DFLOAT4_to_LWGEOM'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry(chip)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','CHIP_to_LWGEOM'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION geometry(bytea)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_from_bytea'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION bytea(geometry)
	RETURNS bytea
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_to_bytea'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION Simplify(geometry, float8)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_simplify2d'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION SnapToGrid(geometry, float8, float8, float8, float8)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_snaptogrid'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION SnapToGrid(geometry, geometry, float8, float8, float8, float8)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_snaptogrid_pointoff'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION Segmentize(geometry, float8)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_segmentize2d'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION line_interpolate_point(geometry, float8)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_line_interpolate_point'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION line_substring(geometry, float8, float8)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_line_substring'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION line_locate_point(geometry, geometry)
	RETURNS float8
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_line_locate_point'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION locate_between_measures(geometry, float8, float8)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_locate_between_m'
	LANGUAGE 'C' IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION intersection(geometry,geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','intersection'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION buffer(geometry,float8)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','buffer'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION convexhull(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','convexhull'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION _ST_LineCrossingDirection(geometry, geometry)
	RETURNS integer
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'ST_LineCrossingDirection'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION ST_LocateBetweenElevations(geometry, float8, float8)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'ST_LocateBetweenElevations'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION ST_SimplifyPreserveTopology(geometry, float8)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','topologypreservesimplify'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION ST_IsValidReason(geometry)
	RETURNS text
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'isvalidreason'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION difference(geometry,geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','difference'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION boundary(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','boundary'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION symdifference(geometry,geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','symdifference'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION GeomUnion(geometry,geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','geomunion'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION collector(geometry, geometry) 
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_collect'
	LANGUAGE 'C' IMMUTABLE;
...
CREATE OR REPLACE FUNCTION geom_accum (geometry[],geometry)
	RETURNS geometry[]
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_accum'
	LANGUAGE 'C' IMMUTABLE;
...
CREATE OR REPLACE FUNCTION collect_garray (geometry[])
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_collect_garray'
	LANGUAGE 'C' IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION unite_garray (geometry[])
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'pgis_union_geometry_array'
	LANGUAGE 'C' IMMUTABLE STRICT;  
...
CREATE OR REPLACE FUNCTION relate(geometry,geometry)
	RETURNS text
	AS 'C:/xampp/pgsql/bin/postgis-1.4','relate_full'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION relate(geometry,geometry,text)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4','relate_pattern'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION ST_Disjoint(geometry,geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4','disjoint'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION _ST_Touches(geometry,geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4','touches'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION _ST_DWithin(geometry,geometry,float8)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_dwithin'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION _ST_Intersects(geometry,geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4','intersects'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION _ST_Crosses(geometry,geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4','crosses'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION _ST_Within(geometry,geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4','within'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION _ST_Contains(geometry,geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4','contains'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION _ST_CoveredBy(geometry,geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'coveredby'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION _ST_Covers(geometry,geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'covers'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION _ST_ContainsProperly(geometry,geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4','containsproperly'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION _ST_Overlaps(geometry,geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4','overlaps'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION IsValid(geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'isvalid'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION GEOSnoop(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'GEOSnoop'
	LANGUAGE 'C' VOLATILE STRICT; 
...
CREATE OR REPLACE FUNCTION ST_Centroid(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'centroid'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION ST_IsRing(geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'isring'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION ST_PointOnSurface(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'pointonsurface'
	LANGUAGE 'C' IMMUTABLE STRICT; 

-- Deprecation in 1.2.3
CREATE OR REPLACE FUNCTION IsSimple(geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'issimple'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION Equals(geometry,geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4','geomequals'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION AsSVG(geometry,int4,int4)
	RETURNS TEXT
	AS 'C:/xampp/pgsql/bin/postgis-1.4','assvg_geometry'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION _ST_AsGML(int4, geometry, int4, int4)
	RETURNS TEXT
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_asGML'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION _ST_AsKML(int4, geometry, int4)
	RETURNS TEXT
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_asKML'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION _ST_AsGeoJson(int4, geometry, int4, int4)
	RETURNS TEXT
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_asGeoJson'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION ST_GeoHash(geometry, int4)
	RETURNS TEXT
	    AS 'C:/xampp/pgsql/bin/postgis-1.4', 'ST_GeoHash'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION NumPoints(geometry)
	RETURNS int4
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_numpoints_linestring'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION NumGeometries(geometry)
	RETURNS int4
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_numgeometries_collection'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION GeometryN(geometry,integer)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_geometryn_collection'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION Dimension(geometry)
	RETURNS int4
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_dimension'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION ExteriorRing(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_exteriorring_polygon'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION NumInteriorRings(geometry)
	RETURNS integer
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_numinteriorrings_polygon'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION InteriorRingN(geometry,integer)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_interiorringn_polygon'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION GeometryType(geometry)
	RETURNS text
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_getTYPE'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION PointN(geometry,integer)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_pointn_linestring'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION X(geometry)
	RETURNS float8
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_x_point'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION Y(geometry)
	RETURNS float8
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_y_point'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION Z(geometry)
	RETURNS float8
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_z_point'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION M(geometry)
	RETURNS float8
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_m_point'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION StartPoint(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_startpoint_linestring'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION EndPoint(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_endpoint_linestring'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION IsClosed(geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_isclosed_linestring'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION IsEmpty(geometry)
	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_isempty'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION SetSRID(geometry,int4) 
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_setSRID'
	LANGUAGE 'C' IMMUTABLE STRICT; 	
...
CREATE OR REPLACE FUNCTION AsBinary(geometry)
	RETURNS bytea
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_asBinary'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION AsText(geometry)
	RETURNS TEXT
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_asText'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION GeometryFromText(text)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_from_text'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION GeomFromWKB(bytea)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_from_WKB'
	LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION CheckAuthTrigger()
	RETURNS trigger AS 
	'C:/xampp/pgsql/bin/postgis-1.4', 'check_authorization'
	LANGUAGE C;

CREATE OR REPLACE FUNCTION GetTransactionID()
	RETURNS xid AS 
	'C:/xampp/pgsql/bin/postgis-1.4', 'getTransactionID'
	LANGUAGE C;
...
--    RETURNS bytea
--    AS 'C:/xampp/pgsql/bin/postgis-1.4','LWGEOM_AsShape'
--    LANGUAGE 'C' IMMUTABLE STRICT; 
...
CREATE OR REPLACE FUNCTION ST_CurveToLine(geometry, integer)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_curve_segmentize'
	LANGUAGE 'C' IMMUTABLE STRICT; 
--
-- SQL-MM
--
...
CREATE OR REPLACE FUNCTION ST_HasArc(geometry)
 	RETURNS boolean
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_has_arc'
	LANGUAGE 'C' IMMUTABLE STRICT; 

CREATE OR REPLACE FUNCTION ST_LineToCurve(geometry)
	RETURNS geometry
	AS 'C:/xampp/pgsql/bin/postgis-1.4', 'LWGEOM_line_desegmentize'
	LANGUAGE 'C' IMMUTABLE STRICT; 
---------------------------------------------------------------
-- END
---------------------------------------------------------------
