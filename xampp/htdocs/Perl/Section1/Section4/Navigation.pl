...
print "<br>";
print "<span class='navlink'>";
    print "<a href='".$Path."Section1/Section4/Index.html'>XHTML</a>";
    print "<h5>";
        print "<span class='navlink'>";
            print "<a href='".$Path."Section1/Section4/Project1.shtml'>JSP Programming</a>";
        print "</span>";
        print "<span class='navlink'>";
            print "<a href='".$Path."Section1/Section4/Project2.shtml'>JSF Programming</a>";
        print "</span>";
    print "</h5>";
print "</span>";
print "<br>";
