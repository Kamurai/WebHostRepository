...
print "<p align='left'>";
    ...
    elsif($Page == 2)
    {
        ...
        print "</br>";
        print "'Gamebox Client: v5.0':<t><a href='http://htkb.dyndns.org/Section3/downloads/GameBox_Client_Installer_v5p0.exe'>Play games from...well, anywhere.</a></br>";
        print "'Gamebox Server: v5.0':<t><a href='http://htkb.dyndns.org/Section3/downloads/GameBox_Server_Installer_v5p0.exe'>Host GameBox.</a></br>";
