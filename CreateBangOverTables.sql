...
create table Adverts (Indext bigint IDENTITY(0,1) PRIMARY KEY, Name varchar(max) not null, Picture varchar(max) not null );
...
insert into Adverts (Name, Picture) VALUES ('Roosterteeth 1', 'RoosterTeeth1.png');
insert into Adverts (Name, Picture) VALUES ('Roosterteeth 2', 'RoosterTeeth2.jpg');
insert into Adverts (Name, Picture) VALUES ('Roosterteeth 3', 'RoosterTeeth3.jpg');
insert into Adverts (Name, Picture) VALUES ('Roosterteeth 4', 'RoosterTeeth4.jpg');
insert into Adverts (Name, Picture) VALUES ('Roosterteeth 5', 'RoosterTeeth5.jpg');
insert into Adverts (Name, Picture) VALUES ('Roosterteeth 6', 'RoosterTeeth6.jpg');
