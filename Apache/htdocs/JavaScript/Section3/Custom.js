...
function Content(input)
{
	document.write("<p align='left'>");
		...
		else if(input == 2)
		{
			...
			document.write("</br>");
			document.write("'Gamebox Client: v5.0':<t><a href='"+GetPath(level+1)+"/Section3/downloads/GameBox_Client_Installer_v5p0.exe'>Play games from...well, anywhere.</a></br>");
			document.write("'Gamebox Server: v5.0':<t><a href='"+GetPath(level+1)+"/Section3/downloads/GameBox_Server_Installer_v5p0.exe'>Host GameBox.</a></br>");
