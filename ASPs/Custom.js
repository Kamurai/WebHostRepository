    ...
    Response.Write("<p align='left'>");
        ...
        else if(input == 3)
        {
            Response.Write("<p align='left'>");
				...
				Response.Write("<a href='http://htkb.dyndns.org/Downloads/Minecraft/forge-1.7.10-10.13.2.1236-installer.jar'>Forge</a></br>");
				Response.Write("<a href='http://htkb.dyndns.org/Downloads/Minecraft/DrZharks MoCreatures Mod v6.3.1.zip'>Dr Zhark's Mo Creatures</a></br>");
				Response.Write("<a href='http://htkb.dyndns.org/Downloads/Minecraft/CustomMobSpawner 3.3.0.zip'>Custom Mob Spawner</a></br>");
				Response.Write("<a href='http://htkb.dyndns.org/Downloads/Minecraft/Reis-Minimap-Mod-1.7.10.jar'>Rei's Minimap</a></br>");
				Response.Write("<a href='http://htkb.dyndns.org/Downloads/Minecraft/[1.7.10]Gender-1.0.2.jar'>iPixeli's Gender Mod</a></br>");
                Response.Write("<a href='http://htkb.dyndns.org/Downloads/Minecraft/BspkrsCore-1.7.10.jar'>Bspkrs Core</a></br>");
                Response.Write("<a href='http://htkb.dyndns.org/Downloads/Minecraft/[1.7.10]Treecapitator-universal-2.0.4.jar'>Tree Capitator</a></br>");
                Response.Write("<a href='http://htkb.dyndns.org/Downloads/Minecraft/MoarFood-5.8.0.jar'>Moar Food</a></br>");
                Response.Write("<a href='http://htkb.dyndns.org/Downloads/Minecraft/MoarOres-2.4.5.jar'>Moar Ores</a></br>");
                Response.Write("<a href='http://htkb.dyndns.org/Downloads/Minecraft/BiblioCraft[v1.10.4][MC1.7.10].jar'>Biblio Craft</a></br>");
                Response.Write("<a href='http://htkb.dyndns.org/Downloads/Minecraft/skin_template.png'>Steve skin template</a></br>");
			Response.Write("</p>");
			Response.Write("<p align='left'>");
