sub Navigation
{
	...
	print "<br>";
	print "<span class='navlink'>";
		print "<a href='".$Path.$DownPath."Affiliation.shtml'>HTKB Affiliations</a>";
	print "</span>";
	print "<br>";
	print "<span class='navlink'>";
	...
	print "<br>";
	print "<span class='navlink'>";
		print "<a href='".$Path.$DownPath."PublicProjects.shtml'>Public Projects</a>";
	print "</span>";
	print "<br>";
	print "<span class='navlink'>";
		print "<a href='".$Path.$DownPath."MemberPages.shtml'>Member Pages</a>";
	print "</span>";
	print "<br>";
}
	...
	print "<p align='left'>";
		...
		elsif($Page == 3)
		{
			print "<p align='left'>";
				...
				print "<a href='./Downloads/Minecraft/forge-1.7.10-10.13.2.1236-installer.jar'>Forge</a></br>";
