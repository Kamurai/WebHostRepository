...
public class Custom
{
    ...
    public String Navigation(int level, int extension)
    {
        ...
        Result += "<br>";
        Result += "<span class='navlink'>";
            Result += "<a href='"+bob.GetPath(level)+"Media"+bob.GetExtension(extension)+"'>Media</a>";
        Result += "</span>";
        Result += "<br>";
        Result += "<span class='navlink'>";
        ...
        Result += "<p align='left'>";
            ...
            else if(input == 3)
            {
                Result += "<p align=\"left\">";
                    ...
                    Result += "Vanilla Server:      (1.10.2) htkb.dyndns.org:25566</br>";
                    Result += "Come Alive Server:   (1.10.2) htkb.dyndns.org:25568</br>";
                        Result += "This is a list of mods that we are using on the server, compatible with 1.10.2.</br>";
                            Result += "<a href='./Downloads/Minecraft/forge-1.10.2-12.18.1.2011-installer.jar'>Forge 1.10.2</a></br>";
                            Result += "<a href='./Downloads/Minecraft/RadixCore-1.10.2-2.1.2-universal.jar'>Radix Core</a></br>";
                            Result += "<a href='./Downloads/Minecraft/MCA-1.10.2-5.2.1-universal.jar'>Minecraft Comes Alive</a></br>";
                            Result += "<a href='./Downloads/Minecraft/Xaeros_Minimap_1.10.8_Forge_1.10.2.jar'>Xaero's Minimap</a></br>";
                    Result += "Pixelmon Server:     (1.8.9)  htkb.dyndns.org:25569</br>";
                        Result += "This is a list of mods that we are using on the server, compatible with 1.8.9.</br>";
                            Result += "<a href='./Downloads/Minecraft/forge-1.8.9-11.15.1.1902-1.8.9-installer.jar'>Forge 1.8.9</a></br>";
                            Result += "<a href='./Downloads/Minecraft/Pixelmon-1.8.9-4.2.7-universal.jar'>Pixelmon</a></br>";
                            Result += "<a href='./Downloads/Minecraft/Xaeros_Minimap_1.10.8_Forge_1.8.9.jar'>Xaero's Minimap</a></br>";
                            Result += "<a href='./Downloads/Minecraft/PixelExtras-1.8.9-2.1.5-universal.jar'>Pixelmon Extras</a></br>";
                    Result += "ArkCraft Server:     (1.8) htkb.dyndns.org:25570</br>";
                        Result += "This is a list of mods that we are using on the server, compatible with 1.8.</br>";
                            Result += "<a href='./Downloads/Minecraft/forge-1.8-11.14.4.1577-installer.jar'>Forge 1.8</a></br>";
                            Result += "<a href='./Downloads/Minecraft/arkcraft-1.1.3-beta.jar'>Ark Craft</a></br>";
                ...
                Result += "<p align=\"left\">";
                    ...
                    Result += "    \\\"..\\Roaming\\ComeAlive\\\"</br>";
                    Result += "    \\\"..\\Roaming\\Pixelmon\\\"</br>";
                    Result += "    \\\"..\\Roaming\\ArkCraft\\\"</br>";
                    ...
                    Result += "    For Pixelmon, then you'll have to change the Java argument -Xmx1G yo -Xmx2G.";
