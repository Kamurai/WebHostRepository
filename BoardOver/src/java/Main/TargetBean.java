...
public class TargetBean implements Serializable
{
    ...
    public TargetBean()
    {
        ...
        strReleaseToAdd = "";
        strURLToAdd = "";
        strValueToAdd = "DeckBuilding";
        fileTargetToAdd = null;
        
        strTargetToSuggest = "";
        strReleaseToSuggest = "";
        strURLToSuggest = "";
        strValueToSuggest = "DeckBuilding";
    ...
    public ArrayList<ArrayList<String>> PullGlobalList(LoginBean userBean)
    {
        ...
        String sqlQuery = "BoardOverPullGlobalListAll;";
    ...
    public ArrayList<ArrayList<String>> PullGlobalCounts()
    {
        ...
        String sqlQuery = "BoardOverPullGlobalCounts";
   ...
   //Pull Random Target Pair: Pull 1 from Personal, plus adjacent (non-lock) or global if at ends
    public ArrayList<ArrayList<String>> PullTargetPair(String strUserIndex)
    {
        ...
        String sqlQuery = "";
        sqlQuery += "BoardOverPullTargetPair " + strUserIndex + ";\n";
    ...
    public void PullAdvertPair()
    {
        ...
        String sqlQuery = "BoardOverPullAdvertPair";
    ...
    public void AddTargetSuggestion()
    {
        ...
        sqlQuery = "BoardOverAddTargetSuggestion '" + 
                strTargetToSuggest + "', '" + 
                strReleaseToSuggest + "', '" + 
                strValueToSuggest + "', '" + 
                strURLToSuggest + "';";
