...
function Content(input)
{
    document.write("<p id=\"idCenterContent\">");
        ...
        else if(input == 3)
        {
				...
				document.write("Vanilla Server:      (1.10.2) htkb.dyndns.org:25566</br>");
				document.write("Come Alive Server:   (1.10.2) htkb.dyndns.org:25568</br>");
					document.write("This is a list of mods that we are using on the server, compatible with 1.10.2.</br>");
					document.write("<a href='./Downloads/Minecraft/forge-1.10.2-12.18.1.2011-installer.jar'>Forge 1.10.2</a></br>");
					document.write("<a href='./Downloads/Minecraft/RadixCore-1.10.2-2.1.2-universal.jar'>Radix Core</a></br>");
					document.write("<a href='./Downloads/Minecraft/MCA-1.10.2-5.2.1-universal.jar'>Minecraft Comes Alive</a></br>");
					document.write("<a href='./Downloads/Minecraft/Xaeros_Minimap_1.10.8_Forge_1.10.2.jar'>Xaero's Minimap</a></br>");
				document.write("Pixelmon Server:     (1.8.9)  htkb.dyndns.org:25569</br>");
					document.write("This is a list of mods that we are using on the server, compatible with 1.8.9.</br>");
					document.write("<a href='./Downloads/Minecraft/forge-1.8.9-11.15.1.1902-1.8.9-installer.jar'>Forge 1.8.9</a></br>");
					document.write("<a href='./Downloads/Minecraft/Pixelmon-1.8.9-4.2.7-universal.jar'>Pixelmon</a></br>");
					document.write("<a href='./Downloads/Minecraft/Xaeros_Minimap_1.10.8_Forge_1.8.9.jar'>Xaero's Minimap</a></br>");
					document.write("<a href='./Downloads/Minecraft/PixelExtras-1.8.9-2.1.5-universal.jar'>Pixelmon Extras</a></br>");
				document.write("ArkCraft Server:     (1.8) htkb.dyndns.org:25570</br>");
					document.write("This is a list of mods that we are using on the server, compatible with 1.8.</br>");
					document.write("<a href='./Downloads/Minecraft/forge-1.8-11.14.4.1577-installer.jar'>Forge 1.8</a></br>");
					document.write("<a href='./Downloads/Minecraft/arkcraft-1.1.3-beta.jar'>Ark Craft</a></br>");
			...
			document.write("<br/>");
				document.write("For first time setups, please follow these steps to make your client compatible with the server:</br>");
					...
					document.write("    \"..\Roaming\ComeAlive\"</br>");
					document.write("    \"..\Roaming\Pixelmon\"</br>");
					document.write("    \"..\Roaming\ArkCraft\"</br>");
					...
					document.write("    For Pixelmon, then you\"ll have to change the Java argument -Xmx1G yo -Xmx2G.");
