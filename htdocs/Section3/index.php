...
<?php
	...
	$title = "Downloadable Projects";
	$centerHeader = "<u>Downloadable Projects</u>";
	$centerContent = "
						<p align='left'>
					...
					";
	$GDR = "";
	$winrar = "<a href='../Downloads/wrar371.exe'>You may need WinRar to open zip files from this site.</a>";
