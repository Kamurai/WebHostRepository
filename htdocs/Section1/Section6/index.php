...
<?php
	...
	$centerHeader = "<u>Database Programming</u>";
	$centerContent = "
						<p align='left'>
							This section is dedicated to Database based programming.
						</p>
					";
	$GDR = "";
	$winrar = "";
	...
	$infoContent = "This is written with PHP.<br><br>
					...
					<a href=\"http://htkb.dyndns.org/Section1/Section6/index.php\">PHP</a><br>
