<%@ Page Title="PHP Programming" Language="C#" MasterPageFile="~/Section1/Template.master" AutoEventWireup="true"
    CodeFile="Project1.aspx.cs" Inherits="_Project1_1" %>
...
<asp:Content ID="VersionContent" runat="server" ContentPlaceHolderID="VersionContent">
	...
	<a href="http://htkb.dyndns.org/Section1/Project1.php">PHP</a></br>
