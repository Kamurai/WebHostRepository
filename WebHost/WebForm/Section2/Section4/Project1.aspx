<%@ Page Title="Warring Nations" Language="C#" MasterPageFile="~/Section2/Section4/Template.master" AutoEventWireup="true"
    CodeFile="Project1.aspx.cs" Inherits="_Project2_4_1" %>
...
<asp:Content ID="VersionContent" runat="server" ContentPlaceHolderID="VersionContent">
	...
	<a href="http://htkb.dyndns.org:81/MVC/Section2/Section4/Project1">ASP.NET MVC App</a></br>
