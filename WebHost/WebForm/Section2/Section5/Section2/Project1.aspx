<%@ Page Title="Land of the Orcish Empire: Age of Magic" Language="C#" MasterPageFile="~/Section2/Section5/Section2/Template.master" AutoEventWireup="true"
...
<asp:Content ID="VersionContent" runat="server" ContentPlaceHolderID="VersionContent">
    <p align="left">
		...
		<a href="http://htkb.dyndns.org/Section2/Section5/Section2/Project1.php">PHP</a></br>
		...
		<a href="http://htkb.dyndns.org:81/MVC/Section2/Section5/Section2/Project1">ASP.NET MVC App</a></br>
