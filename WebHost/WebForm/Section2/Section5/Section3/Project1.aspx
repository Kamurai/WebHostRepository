<%@ Page Title="Elemental Angels" Language="C#" MasterPageFile="~/Section2/Section5/Section3/Template.master" AutoEventWireup="true"
...
<asp:Content ID="VersionContent" runat="server" ContentPlaceHolderID="VersionContent">
	...
	<a href="http://htkb.dyndns.org/Section2/Section5/Section3/Project1.php">PHP</a></br>
	...
	<a href="http://htkb.dyndns.org:81/MVC/Section2/Section5/Section3/Project1">ASP.NET MVC App</a></br>
