<%@ Page Title="Revolutions: Rebellion Against the Fist" Language="C#" MasterPageFile="~/Section2/Section5/Section1/Template.master" AutoEventWireup="true"
...
<asp:Content ID="VersionContent" runat="server" ContentPlaceHolderID="VersionContent">
	...
	<a href="http://htkb.dyndns.org/Section2/Section5/Section1/Project4.php">PHP</a></br>
	...
	<a href="http://htkb.dyndns.org:81/MVC/Section2/Section5/Section1/Project4">ASP.NET MVC App</a></br>
