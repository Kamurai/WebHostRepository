<%@ Page Title="Magic: The Tactical" Language="C#" MasterPageFile="~/Section2/Section6/Template.master" AutoEventWireup="true"
    CodeFile="Project1.aspx.cs" Inherits="_Project2_6_1" %>
...
<asp:Content ID="VersionContent" runat="server" ContentPlaceHolderID="VersionContent">
	...
	<a href="http://htkb.dyndns.org/Section2/Section6/Project1.php">PHP</a></br>
	...
	<a href="http://htkb.dyndns.org:81/MVC/Section2/Section6/Project1">ASP.NET MVC App</a></br>
