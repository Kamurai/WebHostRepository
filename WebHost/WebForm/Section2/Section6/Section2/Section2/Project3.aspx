<%@ Page Title="Ad Infinitum" Language="C#" MasterPageFile="~/Section2/Section6/Section2/Section2/Template.master" AutoEventWireup="true"
    CodeFile="Project3.aspx.cs" Inherits="_Project2_6_2_2_3" %>
...
<asp:Content ID="VersionContent" runat="server" ContentPlaceHolderID="VersionContent">
	...
	<a href="http://htkb.dyndns.org/Section2/Section6/Section2/Section2/Project3.php">PHP</a></br>
	...
	<a href="http://htkb.dyndns.org:81/MVC/Section2/Section6/Section2/Section2/Project3">ASP.NET MVC App</a></br>
