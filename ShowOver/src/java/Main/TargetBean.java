...
public class TargetBean implements Serializable
{
    ...
    public TargetBean()
    {
        ...
        strTargetToAdd = "";
        strReleaseToAdd = "";
        strGenreToAdd = "ComedyS";
        strSettingToAdd = "ModernS";
        strURLToAdd = "";
        fileTargetToAdd = null;
        
        strTargetToSuggest = "";
        strReleaseToSuggest = "";
        strGenreToSuggest = "ComedyS";
        strSettingToSuggest = "ModernS";
        strURLToSuggest = "";
    ...
    public ArrayList<ArrayList<String>> PullGlobalList(LoginBean userBean)
    {
        ...
        String sqlQuery = "ShowOverPullGlobalListAll;";
    ...
    public ArrayList<ArrayList<String>> PullGlobalCounts()
    {
        ...
        String sqlQuery = "ShowOverPullGlobalCounts";
    ...
    public ArrayList<ArrayList<String>> PullTargetPair(String strUserIndex)
    {
        ...
        String sqlQuery = "";
        sqlQuery += "ShowOverPullTargetPair " + strUserIndex + ";\n";
    ...
    public void PullAdvertPair()
    {
        ...
        String sqlQuery = "ShowOverPullAdvertPair";
    ...
    public void AddTargetSuggestion()
    {
        ...
        sqlQuery = "ShowOverAddTargetSuggestion '" + 
                strTargetToSuggest + "', '" + 
                strGenreToSuggest + "', '" + 
                strSettingToSuggest + "', '" + 
                strURLToSuggest + "';";
